...
INSERT INTO menu (item, description, price) VALUES ('grilled chicken taco', 'Taco with farm raised chicken to perfection.', '2.00');
INSERT INTO menu (item, description, price) VALUES ('fried chicken taco', 'Taco with farm raised chicken air fried perfectly so you can enjoy the crunch without the grease.', '2.00');
